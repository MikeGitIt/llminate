...
async fn test_webfetch_real_website() -> Result<()> {
    ...
    assert!(
        result.contains("Example Domain") || result.contains("example"),
...
async fn test_webfetch_github_api() -> Result<()> {
    ...
    assert!(
        result.contains("anthropic") || result.contains("SDK") || result.contains("Python"),
...
async fn test_webfetch_404_error() -> Result<()> {
    ...
    assert!(
        result.contains("404") || result.contains("Not Found"),
...
async fn test_websearch_real_execution() -> Result<()> {
    ...
    assert!(
        result.contains("Claude API")
            || result.contains("requires")
            || result.contains("integration"),
